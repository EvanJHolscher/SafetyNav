 ...
 */
export declare function buildRequest(configuration: MapLibreGlDirectionsConfiguration, waypointsCoordinates: [number, number][], waypointsBearings?: ([number, number] | undefined)[]): {
    method: "get" | "post";
    url: string;
